! function(e, t) {
    ...
    return function(e) {
        ...
        const h = e => document.querySelector(e),
            a = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e,
            u = (e, t = 1) => {
                const i = a(e),
        ...
        r.VantaBase = class {
            constructor(e = {}) {
                ...
                try {
                    ...
                    return h("Init error", e), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), void(this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(o.b)(this.options.backgroundColor)))
                }
        ...
        class n extends o.b {
            constructor(e) {
                s = e.THREE || s, s.Color.prototype.toVector = function() {
        ...
        var o = i(2);
        class s extends o.b {}
        t.default = o.a.register("CELLS", s), s.prototype.defaultOptions = {
            color1: 35980,
            color2: 15918901,
